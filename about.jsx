    ...
    render() {
        return (
            <div >
                  ...
                  <h1 style={{marginLeft:"-500px",marginTop:"100px",color:"white"}}>Our Motive</h1>
 <Row>
<p style={{marginLeft:"500px",marginTop:"-100px",color:"white"}} >
...
<p style={{marginLeft:"500px",marginTop:"5px",color:"white"}} >
...
<Container style={{marginBottom:"100px"}}>
  ...
  <Row style={{paddingLeft:"80px",marginTop:"100px"}}>
   ...
   <h3 style={{color:"White",marginLeft:"60px",marginTop:"0px"}}>Jasvith</h3>
    <h5 style={{color:"White",marginLeft:"60px",marginTop:"-20px"}}>Devopler</h5>    </Col>
    <Col xs={6} md={4} style={{paddingLeft:"30px"}}>
  
      <Image src={require('./pic.jpg')}  roundedCircle  width="200px" height="200px"/>
    
    <h3 style={{color:"White",marginLeft:"50px",marginTop:"0px"}}>Cherishma</h3>
    <h5 style={{color:"White",marginLeft:"50px",marginTop:"-20px"}}>Documentation</h5>
  ...
  <Row style={{marginLeft:"200px",marginTop:"120px",marginBottom:"10px"}}>
   ...
   <h3 style={{color:"White",marginLeft:"50px",marginTop:"0px"}}>Nivedha</h3>
    <h5 style={{color:"White",marginLeft:"60px",marginTop:"-20px"}}>Team Leader</h5>    </Col>
    <Col xs={6} md={4} style={{marginLeft:"150px"}}>
   
      <Image src={require('./pic.jpg')}  roundedCircle  width="200px" height="200px"/>
  
      <h3 style={{color:"White",marginLeft:"50px",marginTop:"0px"}}>Viswesh</h3>
    <h5 style={{color:"White",marginLeft:"60px",marginTop:"-20px"}}>Designer</h5>    </Col>
    </Row>
  </Row>
</Container>
<hr style={{backgroundColor:"grey",marginLeft:"150px",marginRight:"150px"}}></hr>
